...
public class L_Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clickToLogin = findViewById(R.id.registerNow);
        ...
        clickToLogin.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(getApplication(), L_Register.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        buttonLogin.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(L_Login.this, "Enter email", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(password))
                {
                    Toast.makeText(L_Login.this, "Enter password", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>()
                        {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task)
                            {
                                ...
                                {
                                    Toast.makeText(L_Login.this, "Authentication failed.", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
            }
